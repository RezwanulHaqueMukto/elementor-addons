...
(function (factory) {
	...
	var widgetsAccordion = $.widget("ui.accordion", {
		...
		_create: function () {
			...
			this._addClass(
				"ui-accordion",
				"ui-widget rez-accordion -user-interface-helper-reset"
			);
		...
		_processPanels: function () {
			...
			this._addClass(
				...
				"rez-accordion -user-interface-helper-reset ui-widget-content"
			);
	...
	$.widget("ui.autocomplete", {
		...
		_create: function () {
			...
			this._addClass(
				this.liveRegion,
				null,
				"rez-accordion -user-interface-helper-hidden-accessible"
			);
	...
	var widgetsControlgroup = $.widget("ui.controlgroup", {
		...
		refresh: function () {
			...
			if (this.options.direction === "horizontal") {
				this._addClass(null, "rez-accordion -user-interface-helper-clearfix");
			}
			this._initWidgets();
	...
	function Datepicker() {
		...
		this.dpDiv = datepicker_bindHover(
			$(
				"<div id='" +
					this._mainDivId +
					"' class='ui-datepicker ui-widget ui-widget-content rez-accordion -user-interface-helper-clearfix ui-corner-all'></div>"
			)
		);
	}
				...
				dpDiv: !inline
					...
					: datepicker_bindHover(
							$(
								"<div class='" +
									this._inlineClass +
									" ui-datepicker ui-widget ui-widget-content rez-accordion -user-interface-helper-clearfix ui-corner-all'></div>"
							)
					  ),
			};
		},
		...
		_generateHTML: function (inst) {
			...
			for (row = 0; row < numMonths[0]; row++) {
				...
				for (col = 0; col < numMonths[1]; col++) {
					...
					calender +=
						"<div class='ui-datepicker-header ui-widget-header rez-accordion -user-interface-helper-clearfix" +
						cornerClass +
						"'>" +
	...
	$.widget("ui.dialog", {
		...
		_createTitlebar: function () {
			...
			this._addClass(
				...
				"ui-dialog-titlebar",
				"ui-widget-header rez-accordion -user-interface-helper-clearfix"
			);
		...
		_createButtonPane: function () {
			...
			this._addClass(
				...
				"ui-widget-content rez-accordion -user-interface-helper-clearfix"
			);
	...
	$.widget("ui.tabs", {
		...
		_processTabs: function () {
			...
			this._addClass(
				this.tablist,
				"ui-tabs-nav",
				"rez-accordion -user-interface-helper-reset rez-accordion -user-interface-helper-clearfix ui-widget-header"
			);
